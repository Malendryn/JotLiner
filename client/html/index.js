...
window.addEventListener('load', async function() {
    ...
    await FF.loadModule("./modules/core/fem_core_ContextMenu.js");         // FG.openContextMenu(): Generic context menu handler
    await FF.loadModule("./modules/core/fem_core_DCHContextMenu.js");      // DCH-specific context menu handler
    await FF.loadModule("./modules/core/fem_core_PopupDialog.js");         // FG.openPopup(): Generic popup handler
